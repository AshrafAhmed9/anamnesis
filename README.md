...
| **Agent Skills Repo** | Used during development for schema design and vector-index query tuning; see [`.claude-skills/README.md`](.claude-skills/README.md), which also includes honest tool feedback for Cockroach Labs. |
